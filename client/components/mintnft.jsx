...
export function Mintnft() {
    ...
    return (
        <div className="flex flex-col">
            <Button onClick={handleSubmit} type="submit" className="mt-6 ">
                Get Certificate
            </Button>
            <p>{feedback}</p>
            <a className="text-center underline" href="https://testnets.opensea.io/assets/amoy/0xe8e9e68a61570ff81296543509722e2c5514025c/1">Check your nft</a>
        </div>
    );
}
